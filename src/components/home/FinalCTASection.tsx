...
export const FinalCTASection: React.FC<FinalCTASectionProps> = ({ onNavigate }) => {
  ...
  return (
    <section className="py-32 px-4 sm:px-6 lg:px-8 bg-[#0F1219] border-t border-white/[0.08] relative overflow-hidden">
      ...
      >
        ...
        {/* Badge */}
        <motion.div variants={item} className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#1E2638] border border-[#D6B77A]/30 text-xs font-tag text-[#D6B77A] mb-8 shadow-lg">
