      ...
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {filtered.map((sol) => (
            <div
              key={sol.id}
              className="p-8 rounded-3xl bg-[#090C16] border border-slate-800 hover:border-emerald-400/40 transition-all duration-300 flex flex-col justify-between group shadow-xl"
            >
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="text-2xl font-display font-bold text-white group-hover:text-emerald-200 transition-colors">
                        {sol.title}
                      </h3>
                ...
                <div className="flex flex-wrap items-center gap-1.5">
                  ...
                  {sol.architectureLayers.map((l, i) => (
                    <span key={i} className="text-[10px] font-mono px-2 py-0.5 rounded bg-slate-900 text-emerald-300 border border-slate-800">
                      {l}
                    </span>
                  ))}
                </div>
