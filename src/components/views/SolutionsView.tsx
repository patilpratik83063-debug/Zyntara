      ...
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {filtered.map((sol) => (
            <div
              key={sol.id}
              className="p-8 rounded-3xl bg-[#141A26] border border-slate-800 hover:border-emerald-400/40 transition-all duration-300 flex flex-col justify-between group shadow-xl"
            >
