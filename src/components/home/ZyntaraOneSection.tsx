...
export const ZyntaraOneSection: React.FC<ZyntaraOneSectionProps> = ({ onNavigate }) => {
  ...
  return (
    <section id="zyntara-one-section" className="py-28 px-4 sm:px-6 lg:px-8 bg-[#07090F] relative overflow-hidden border-t border-white/[0.08]">
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[900px] h-[500px] bg-[#8B7CFF]/08 blur-[160px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-14 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              return (
                <button
                  ...
                  className={`w-full p-4 rounded-2xl text-left transition-all duration-300 flex items-center justify-between border cursor-pointer group ${
                    isSelected
                      ? 'bg-gradient-to-r from-[#181D2E] to-[#101422] border-[#D6B77A]/50 shadow-[0_8px_30px_rgba(214,183,122,0.15)] scale-[1.02]'
          ...
          <div className="lg:col-span-7 p-6 sm:p-8 rounded-3xl bg-[#0D1018]/95 border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.6)] backdrop-blur-xl relative overflow-hidden space-y-6">
            ...
            <div className="absolute top-0 right-0 w-80 h-80 bg-[#8B7CFF]/08 rounded-full blur-[100px] pointer-events-none" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-white/[0.08]">
              <div>
                <div className="flex items-center gap-2.5 mb-1.5">
                  ...
                  <span className="font-mono text-xs text-[#8B7CFF] uppercase tracking-wider">
              ...
              <div className="flex items-center gap-2 shrink-0">
                <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-mono bg-[#141824] text-[#59D6C4] border border-[#59D6C4]/30">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#59D6C4] animate-ping mr-1.5" />
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {currentLayer.technicalDetails.map((detail, idx) => (
                  ...
                  >
                    <div className="w-2 h-2 rounded-full bg-[#8B7CFF] shrink-0" />
            ...
            <div className="pt-4 border-t border-white/[0.08] flex flex-wrap items-center justify-between gap-4">
              <div className="text-xs font-mono text-[#7E8491] flex items-center gap-2">
                ...
                <span className="text-[#8B7CFF]">{currentLayer.connectedSystems.join(', ')}</span>
              </div>
