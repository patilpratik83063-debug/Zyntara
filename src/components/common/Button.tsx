...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary: 'bg-gradient-to-r from-[#695CF6] to-[#5143E0] hover:from-[#7B6FF7] hover:to-[#6052ED] text-white font-semibold border border-[#9D91FF]/30 shadow-[0_4px_24px_rgba(105,92,246,0.3)] hover:shadow-[0_8px_32px_rgba(105,92,246,0.48)] active:scale-[0.98]',
    glow: 'bg-gradient-to-r from-[#8B7CFF] via-[#7A69F5] to-[#D6B77A] hover:brightness-110 text-[#050506] font-bold border border-[#F5E7CA]/40 shadow-[0_4px_24px_rgba(214,183,122,0.32)] hover:shadow-[0_8px_36px_rgba(214,183,122,0.5)] active:scale-[0.98]',
    ...
    outline: 'bg-transparent hover:bg-white/[0.04] text-[#E0E2EC] hover:text-white font-medium border border-white/15 hover:border-[#8B7CFF]/50 active:scale-[0.98]',
