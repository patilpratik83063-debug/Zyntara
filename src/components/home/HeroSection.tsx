    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center my-auto">
        ...
        >
          ...
          <motion.h1 className="text-4xl sm:text-6xl lg:text-7xl xl:text-8xl font-display font-extrabold text-[#F5F3EE] tracking-tight leading-[1.03]">
            ...
            <span className="block sm:mt-1">
              ...
              <span className="relative inline-block">
                ...
                >
                  <motion.path
                    d="M4 16 C 62 6, 132 22, 184 12 S 304 7, 314 11"
                  ...
                  />
                  <defs>
                    <linearGradient id="hero-flourish" x1="0" y1="0" x2="320" y2="0" gradientUnits="userSpaceOnUse">
          ...
          <motion.p variants={item} className="text-base sm:text-lg text-[#B6BAC4] font-normal leading-relaxed max-w-xl">
            Replace manual busywork with intelligent systems that think, connect, and move on their own — so your company compounds instead of churning.
          </motion.p>
